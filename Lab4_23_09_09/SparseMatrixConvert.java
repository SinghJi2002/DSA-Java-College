...
class SingleLinkedLists{
    ...
    public void displayTupleFormat(int row,int column){
        int col=1;
        int rown=1;
        Node temp=head;
        while(temp!=null){
...
public class SparseMatrixConvert{
    public static void main(String[] args){
        ...
        while(index<totalElement){
            ...
            newLinkedList.insertLast(element);
        }

        newLinkedList.displayTupleFormat(row,column);
